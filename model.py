...
class Inception_v3:
    ...
    def prediction(self, img_path, savelocation="food_classification_saved/", imagename="", show=True, save=False):
        """
        ...
        #directory = 'E:/UCSC/CMPM202/Project3/food-image-classifier-master/examples/'
        ...
        if self.model is not None:
            ...
            if show:
                ...
                plt.savefig(savelocation + imagename +'.png', dpi=None, bbox_inches='tight', pad_inches=0.1)
                #print("Saved to predicted-saved") 
                #plt.show()                          
                if save:
                    plt.savefig(
