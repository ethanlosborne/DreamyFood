...
**Important Notes**
There is dummy text in the classificationresults.txt file so it could be uploaded to Github. Open this file and erase it before running the model. Also, the Food Classifier trained model was too large to upload, you can [find it here](https://drive.google.com/drive/folders/1U4wu1PZ9iTMh4bXk-OCYFzjasGp56Fo-?usp=sharing). You need it to run the model, so make sure to download it! 
